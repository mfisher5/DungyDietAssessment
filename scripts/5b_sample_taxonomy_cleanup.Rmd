...
blast.dat.filter %>% group_by(Site,missing_rm) %>%
  ...
  scale_fill_manual(values=c("cornflowerblue","black"), name="Missing Tax") +
  theme_classic()
```
<br>
...
write.csv(summary_dat, here(outdir, paste0(marker,"_","r",run.num,"sample_taxonomy_filtering_summary.csv")))
```
<br>
