...
I'm interested in the following orders: 
$\zeta_1$ = taxonomic richness per crab, among crab at a sampling site

$\zeta_2$ = taxonomic richness per sampling site, among sites within the same estuary

$\zeta_3$ = taxonomic richness per estuary
