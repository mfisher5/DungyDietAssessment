...
- Hydroids are absent from the species data; placed into the Gelatinous Zooplankton category
...
risk.dat <- eindex.dat %>%
  filter(ncrab.x > 2) %>%
  left_join(ed.dat %>% dplyr::select(-functional_group,-ncrab), by=c("taxon"="new_taxon"))
