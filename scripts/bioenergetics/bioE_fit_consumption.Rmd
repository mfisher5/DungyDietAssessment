---
title: "Dungeness crab Bioenergetic Updates - Consumption curve"
...
Use crab NRG to validate a green crab bioenergetics model for Willapa Bay. 
...
```{r Part5, echo=TRUE, warning=FALSE, eval=FALSE}
