...
bash /c/Users/mfisher5/Documents/DungyDietAssessment/scripts/1.run.cutadapt.sh "${FASTQFOLDER}" "${METADATA}" "${OUTPUTFOLDER}" "${MINLENGTH}" >> /c/Users/mfisher5/Documents/DungyDietAssessment/data/cutadapt/log_20220930.txt