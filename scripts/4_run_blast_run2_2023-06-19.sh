...
################################################################################
blast_output='/mnt/nfs/home/KellyCEG/mcf/DungyDietAssessment/run2_hash_key_blast_2023-06-19.fasta'
blast_input='/mnt/nfs/home/KellyCEG/mcf/DungyDietAssessment/run2/hash_key.fasta'
# BLAST PARAMETERS
PERCENT_IDENTITY="85"
WORD_SIZE="15"
EVALUE="1e-30"
...
################################################################################
blast_output='/mnt/nfs/home/KellyCEG/mcf/DungyDietAssessment/run2_hash_key_clean_blast_2023-06-19.fasta'
blast_input='/mnt/nfs/home/KellyCEG/mcf/DungyDietAssessment/run2/Hash_Key_clean.fasta'
####################### BLAST CLUSTERS #######################
echo $(date +%H:%M) "BLASTing..."
/mnt/nfs/home/KellyCEG/ncbi-blast-2.13.0+/bin/blastn -query "${blast_input}" -db "${BLAST_DB}" -num_threads 16 -perc_identity "${PERCENT_IDENTITY}" -word_size "${WORD_SIZE}" -evalue "${EVALUE}" -max_target_seqs "${MAXIMUM_MATCHES}" -culling_limit="${CULLING}" -outfmt "6 qseqid sseqid sacc pident length mismatch gapopen qcovus qstart qend sstart send evalue bitscore staxids qlen sscinames sseq" -out "${blast_output}"
